...
class WallpaperConfig : public myqmlplugin::configs::CSerializable {
	Q_OBJECT
	QML_ELEMENT
	QML_UNCREATABLE("")
...
public:
	explicit WallpaperConfig(QObject *root = nullptr, QObject *parent = nullptr);
...
private:	
	const QString m_className = "WallpaperConfig";
