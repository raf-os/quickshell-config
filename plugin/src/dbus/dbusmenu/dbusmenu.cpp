...
//
// DBusMenu::DBusMenu(const QString &service, const QString &path, QObject
// *parent)
//     : QObject(parent),
...
//
//   m_interface =
//       new DBusMenuInterface(service, path, QDBusConnection::sessionBus(),
//       this);
//
...
//
//         if (reply.isError()) {
//           qCWarning(logNSDBusMenu) << "Error updating layout for menu" <<
//           parent
//                                    << "of" << this << ":\n"
//                                    << reply.error();
//         } else {
//           auto layout = reply.argumentAt<1>();
//           this->updateLayoutRecursively(layout, m_items.value(parent),
//           depth);
//         }
//
//         delete call;
